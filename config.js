const topBarCenterText = `KF8CJW - FM08ak`;
// Menu items
...
const aIMG = [
  ...
  [
    "LOCAL RADAR",
    "https://radar.weather.gov/ridge/standard/KRLX_loop.gif",
  ],
  [
    "NOAA D-RAP",
  ...
  ["VIDEO EXAMPLE", "https://stream.citynet.net/Snowshoe/smil:boathouse.smil/playlist.m3u8",],
  ["HF PROPAGATION",
